...
[![npm version](https://img.shields.io/npm/v/@ynode/autoshutdown.svg)](https://www.npmjs.com/package/@ynode/autoshutdown) [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

A [Fastify 5.x](https://www.fastify.io/) plugin that automatically shuts down idle cluster workers after a period with zero in-flight requests. This is useful for conserving system resources in environments where workers are scaled dynamically based on load.
